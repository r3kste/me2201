...
cam.plot_pitch_circle(ax, motion, label="Pitch Circle")
...
motion.plot_rise(ax, label="Rise")
motion.plot_velocity(ax, label="Velocity")
motion.plot_acceleration(ax, label="Acceleration")
